...
x1 <- paste("$$\\Pr(\\theta_{1}|x_{1})=\\frac{\\Pr(X=x_{1}|\\theta_{1})\\Pr(\\theta_{1})}{\\Pr(X=x_{1}|\\theta_{1})\\Pr(\\theta_{1})+\\Pr(X=x_{1}|\\theta_{2})\\Pr(\\theta_{2})}=\\frac{",rand1,"*",pr1,"}{",rand1,"*",pr1,"+",rand4,"*",pr2,"}=",round((rand1*pr1)/(rand1*pr1+rand4*pr2),4),", \\text{ to 4 d.p.}$$")

x2 <- paste("$$\\Pr(\\theta_{1}|x_{2})=\\frac{\\Pr(X=x_{2}|\\theta_{1})\\Pr(\\theta_{1})}{\\Pr(X=x_{2}|\\theta_{1})\\Pr(\\theta_{1})+\\Pr(X=x_{2}|\\theta_{2})\\Pr(\\theta_{2})}=\\frac{",rand2,"*",pr1,"}{",rand2,"*",pr1,"+",rand5,"*",pr2,"}=",round((rand2*pr1)/(rand2*pr1+rand5*pr2),4),", \\text{ to 4 d.p.}$$")

x3 <- paste("$$\\Pr(\\theta_{1}|x_{3})=\\frac{\\Pr(X=x_{3}|\\theta_{1})\\Pr(\\theta_{1})}{\\Pr(X=x_{3}|\\theta_{1})\\Pr(\\theta_{1})+\\Pr(X=x_{3}|\\theta_{2})\\Pr(\\theta_{2})}=\\frac{",rand3,"*",pr1,"}{",rand3,"*",pr1,"+",rand6,"*",pr2,"}=",round((rand3*pr1)/(rand3*pr1+rand6*pr2),4),", \\text{ to 4 d.p.} $$")
...
Suppose it is known by `r ex` that these symptoms occur with probabilities that depend on the problem. The probabilities $\Pr(X=x|\theta)$ are given below. Construct a diagnostic rule for these symptoms and determine the probability of misdiagnosis.
